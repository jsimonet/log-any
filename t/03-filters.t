...
nok Log::Any.will-trace(     :pipeline( 'will-log' ) );
nok Log::Any.will-debug(     :pipeline( 'will-log' ) );
nok Log::Any.will-info(      :pipeline( 'will-log' ) );
nok Log::Any.will-notice(    :pipeline( 'will-log' ) );
ok  Log::Any.will-warning(   :pipeline( 'will-log' ) );
ok  Log::Any.will-error(     :pipeline( 'will-log' ) );
ok  Log::Any.will-critical(  :pipeline( 'will-log' ) );
ok  Log::Any.will-alert(     :pipeline( 'will-log' ) );
ok  Log::Any.will-emergency( :pipeline( 'will-log' ) );
